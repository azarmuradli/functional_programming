...
//Please write your neptun code here: EZEEEL
/*
...
| x<10 && x>=5 = x/5 + ATM (x rem 5)
| x<5 && x>=2 = x/2 + ATM (x rem 2)
| x==1 = 1
= 0
...
MyFunGCD a b 
| a ==0 || b==0 = abort "Cannot calculate gcd of 0"
| findGCD a b == a || findGCD a b == b = "either number is a multiple of the other"
